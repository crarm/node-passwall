...
const UUID = process.env.UUID || 'b4fea006-e737-47ef-8f73-cc3311a38aa8'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'b4fea006-e737-47ef-8f73-cc3311a38aa8';            // 获取节点的订阅路径
